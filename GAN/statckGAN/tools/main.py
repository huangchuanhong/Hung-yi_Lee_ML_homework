...
def parse_args():
    ...
    parser.add_argument('--s2_batch_size', type=int, default=128)
    ...
    parser.add_argument('--s2_test_checkpoint_path', type=str, default='output/checkpoints/s2/generator_epoch_180.pth')
